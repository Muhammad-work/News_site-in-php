        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                if (isset($_SESSION['role']) &&  $_SESSION['role'] == '1') {
                    ...
                    post.post_date, category.category_name, user.username,post.category
                    FROM news_site.post 
                ...
                <?php
                    ...
                    echo "<h2>No Recods Found</h2>";
                    // exit;
                }
                $sql1 = "SELECT * FROM news_site.post";
                $result1 = mysqli_query($con, $sql1) or die("Query Feild!");
